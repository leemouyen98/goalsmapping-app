  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'slide-in-right':  'slideInRight 0.24s cubic-bezier(0.4,0,0.2,1) both',
        'slide-in-left':   'slideInLeft 0.24s cubic-bezier(0.4,0,0.2,1) both',
        'uw-fade':         'uwFadeIn 0.2s ease both',
